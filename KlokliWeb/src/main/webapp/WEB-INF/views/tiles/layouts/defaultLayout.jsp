...
<html lang="en">
  <head>
    ...
    -->
    <title>Rukain :: <tiles:getAsString name="title" /></title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> <tiles:getAsString name="title" /></h1>
    ...
    <script src="<c:url value='/static/js/plugins/pace.min.js' />"></script>
